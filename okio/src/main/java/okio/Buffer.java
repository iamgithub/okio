...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
   ...
   * {@code out}.
   */
  public Buffer writeTo(OutputStream out, long offset, long byteCount) throws IOException {
    checkOffsetAndCount(size, offset, byteCount);
    skip(offset);
    ...
    while (copied < byteCount) {
      int toCopy = (int) Math.min(byteCount - copied, s.limit - s.pos);
